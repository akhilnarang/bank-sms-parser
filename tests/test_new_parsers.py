...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "union",
            "union/account_mob_bk_debit.txt",
            {
                ...
                "counterparty": "RAHUL SHARMA",
                "reference_number": "000000000000",
                "balance": Decimal("7138.46"),
                "transaction_date": datetime.date(2026, 8, 25),
                "transaction_time": datetime.time(9, 50, 1),
            },
        ),
        (
            "union",
            "union/account_mob_bk_credit.txt",
            {
                ...
                "account_mask": "*0000",
                "reference_number": "000000000000",
                "balance": Decimal("4364.46"),
                "transaction_date": datetime.date(2026, 8, 28),
                "transaction_time": datetime.time(11, 9, 48),
            },
        ),
        (
            "union",
            "union/account_imps_credit.txt",
            {
                ...
                "reference_number": "000000000000",
                "channel": "imps",
                "balance": Decimal("2198.72"),
                "transaction_date": datetime.date(2026, 9, 11),
                "transaction_time": datetime.time(12, 4, 11),
            },
        ),
        (
            "union",
            "union/account_branch_credit.txt",
            {
                ...
                "account_mask": "*0000",
                "channel": "branch",
                "balance": Decimal("3523.40"),
                "transaction_date": datetime.date(2026, 9, 8),
                "transaction_time": datetime.time(12, 51, 28),
            },
        ),
        (
            "canara",
            "canara/account_upi_debit.txt",
            {
                "email_type": "canara_account_upi_debit_alert",
                "direction": "debit",
                "amount": Decimal("7.00"),
                "currency": "INR",
                "account_mask": "XXXX0000",
                "counterparty": "RAHUL SHARMA",
                "reference_number": "000000000000",
                "channel": "upi",
                "balance": Decimal("8018.54"),
                "transaction_date": datetime.date(2026, 9, 13),
            },
        ),
        (
            "canara",
            "canara/account_upi_credit.txt",
            {
                ...
                "currency": "INR",
                "account_mask": "XXXX0000",
                "counterparty": "Mr RAHUL SHARMA",
                "reference_number": "000000000000",
                "channel": "upi",
                "balance": Decimal("3775.74"),
                "transaction_date": datetime.date(2026, 9, 13),
            },
        ),
        (
            "canara",
            "canara/account_txn_declined.txt",
            {
                "email_type": "canara_account_txn_declined_alert",
                "direction": "declined",
                "amount": Decimal("637.70"),
                "currency": "INR",
                "account_mask": "XX1234",
                "counterparty": "ACME STORE",
                "transaction_date": datetime.date(2026, 8, 18),
        ...
        (
            ...
            "indian_bank/account_debit.txt",
            {
                ...
                "reference_number": "000000000000",
                "channel": None,
                "balance": Decimal("415919.25"),
                "transaction_date": datetime.date(2026, 9, 14),
            },
        ),
        (
            "indian_bank",
            "indian_bank/account_imps_credit.txt",
            {
                ...
                "currency": "INR",
                "account_mask": "XXXX0000",
                "counterparty": "Mobile 9XXXXXX00000",
                "reference_number": "000000000000",
                "channel": "imps",
                "transaction_date": datetime.date(2026, 9, 6),
            },
        ...
        (
            "indian_bank",
            "indian_bank/account_credit.txt",
            {
                ...
                "counterparty": "RAHUL SHARMA",
                "reference_number": "000000000000",
                "balance": Decimal("2154.17"),
                "transaction_date": datetime.date(2026, 9, 13),
            },
        ),
        (
            "indian_bank",
            "indian_bank/account_upi_credit.txt",
            {
                "email_type": "indian_bank_account_credit_alert",
                "direction": "credit",
        ...
        (
            "kotak",
            "kotak/account_upi_debit_variant.txt",
            {
                "email_type": "kotak_account_upi_debit_alert",
                "direction": "debit",
                "amount": Decimal("100.00"),
        ...
        (
            "kotak",
            "kotak/account_upi_credit_variant.txt",
            {
                "email_type": "kotak_account_upi_credit_alert",
                "direction": "credit",
                "amount": Decimal("100.00"),
